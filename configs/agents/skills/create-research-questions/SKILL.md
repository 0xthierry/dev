...
2. **Write the research questions** to `ai_docs/tasks/TASKNAME/YYYY-MM-DD-research-questions.md`
   - First, check if a related task directory exists: `ls ai_docs/tasks | grep -i "eng-XXXX"`
   ...
   - Directory naming:
     - With ticket: `ai_docs/tasks/ENG-1478-parent-child-tracking/2025-01-08-research-questions.md`
     - Without ticket: `ai_docs/tasks/authentication-flow/2025-01-08-research-questions.md`
