...
critical lenses. The deliverable is a synthesized verdict — do NOT make changes.
...
## Step 2 — Detect Model and Spawn Reviewers
...
## Step 3 — Verify and Synthesize Verdict
...
## Step 4 — Render Judgment

After synthesizing the reviewers, apply your own judgment. Using the stated intent as your
frame, state which findings you would accept and which you would reject —
