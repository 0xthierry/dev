...
Code examples for each rule in [TypeScript best practices](typescript.md). The underlying principles are language-agnostic. See the **type-system-discipline** and **boundary-discipline** principle skills.
