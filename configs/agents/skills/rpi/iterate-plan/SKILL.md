...
6. **Check whether you are already in a git worktree**:
...
8. Respond following the selected template exactly. Do not include a summary or other information. Include artifact paths if available.
