...
4. **Wait for all sub-agents to complete and synthesize findings:**
   ...
   - Verify all .tasks paths are correct (task-specific files go in .tasks/)
   - Highlight patterns, connections, and architectural decisions
   - Answer the user's specific questions with concrete evidence

5. **Gather metadata for the research document:**
   - Filename: `.tasks/TASKNAME/NN-research-DESCRIPTION.md`
     - First, check the task directory in your system prompt. If you do not see it, find the task directory: `ls -La .tasks | grep -i "eng-XXXX"`
     ...
     - Directory naming:
       - With ticket: `.tasks/ENG-1478-parent-child-tracking/02-research-parent-child-tracking.md`
       - Without ticket: `.tasks/authentication-flow/02-research-auth-flow.md`
