...
1. **Read all @-mentioned files immediately and FULLY**:
    ...
    - Ticket files (e.g., `.tasks/<task slug>/ticket.md`)
...
2. **Write the research questions** to `.tasks/TASKNAME/NN-research-questions-DESCRIPTION.md`
   - First, check if a related task directory exists: `ls -La .tasks | grep -i "eng-XXXX"`
   ...
   - Directory naming:
     - With ticket: `.tasks/ENG-1478-parent-child-tracking/01-research-questions-parent-child-tracking.md`
     - Without ticket: `.tasks/authentication-flow/01-research-questions-auth-flow.md`
