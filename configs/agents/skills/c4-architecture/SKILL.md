...
description: Generate architecture documentation using C4 model Mermaid diagrams. Invoke this skill only when the user explicitly asks to use or invoke the c4-architecture skill. Never invoke it automatically based on architecture-related requests or keywords.
---
