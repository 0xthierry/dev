...
You will receive:
1. A task directory path (e.g., \`ai_docs/tasks/eng-1234-feature/\`)
2. And/or a specific plan file path (e.g., \`ai_docs/tasks/eng-1234-feature/2026-01-03-plan.md\`)
...
- If only task directory provided, find the most recent \`*-plan.md\` file:
  \`\`\`bash
  ls -t ai_docs/tasks/{task-dir}/*-plan.md | head -1
  \`\`\`
