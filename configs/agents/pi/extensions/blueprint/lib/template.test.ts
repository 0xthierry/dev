  ...
  test("renders input, context, blueprint, and node result fields", () => {
    ...
    const state: BlueprintTemplateState = {
      blueprint: {
        ...
        scope: "project",
        filePath: "/repo/.pi/blueprint/implement.jsonc",
        dir: "/repo/.pi/blueprint",
        definition: { name: "implement", description: "Implement", start: "done", nodes: { done: { type: "stop" } } },
      },
...
function minimalState(): BlueprintTemplateState {
  return {
    blueprint: {
      ...
      description: "Simple",
      scope: "user",
      filePath: "/blueprints/simple.jsonc",
      dir: "/blueprints",
      definition: { name: "simple", description: "Simple", start: "done", nodes: { done: { type: "stop" } } },
    },
    input: { task: "task" },
