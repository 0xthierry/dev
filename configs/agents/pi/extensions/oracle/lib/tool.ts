...
export function registerOracleTool(pi: ExtensionAPI, runtime: OracleRuntime): void {
  pi.registerTool<typeof OracleParamsSchema, OracleToolDetails>({
    ...
    promptSnippet:
      "Consult the Oracle, a separate state-of-the-art intelligence, for hard problems or a second opinion — always with complete, self-contained context.",
    promptGuidelines: [
