...
export function getGoogleCookieHosts(): string[] {
  return GOOGLE_ORIGINS.map((origin) => new URL(origin).hostname);
}

export function isGoogleCookieName(name: string): boolean {
