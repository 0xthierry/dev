...
const EXPLORER_PROMPT = [
  ...
  "- Stop when you have enough evidence for a useful handoff; avoid open-ended exploration.",
  "- Do not paste large file contents, command logs, or repeated snippets into your final response.",
  "",
  "Rules:",
  ...
  "- Prefer concise evidence, architecture links, risks, and start-here guidance over long narrative summaries.",
  ...
  "",
  "Final output shape:",
  "- Summary: 2-5 bullets with the direct answer.",
  "- Evidence: relevant files/functions with line ranges and why they matter.",
  "- Start here: the first file or command the parent/next agent should inspect.",
  "- Gaps/risks: only material unknowns or risks.",
].join("\n");
