...
Use cliproxyapi/gpt-6-sol at high effort when the task requires diagnosing a bug or making changes; use cliproxyapi/gpt-6-astra with high effort for planning and design decisions. For routine code review, including ordinary correctness and security checks, use cliproxyapi/gpt-5.6-terra at medium effort.
