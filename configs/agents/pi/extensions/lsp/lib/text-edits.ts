...
export function hasOverlappingTextEdits(text: string, edits: LspTextEdit[]): boolean {
...
export function collectWorkspaceEdits(edit: WorkspaceEdit | undefined, uri: string): LspTextEdit[] {
  if (!edit) return [];
...
function textEditRangesConflict(left: { start: number; end: number }, right: { start: number; end: number }): boolean {
