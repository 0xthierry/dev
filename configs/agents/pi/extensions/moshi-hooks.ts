...
const helperBinary = "/home/thierry/.local/bin/moshi-hook";
...
function sessionID(event: Record<string, unknown>, ctx: Record<string, unknown>): string {
  ...
  return firstString(event.session_id as string, event.sessionId as string, sessionFile, ctx.cwd as string, "pi");
}
