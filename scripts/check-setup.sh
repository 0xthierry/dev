...
bash -n scripts/check-setup.sh scripts/test-codex-app-installer.sh scripts/test-ssh-config.sh .githooks/pre-commit
shellcheck setup.sh install/*.sh install/hosts/*.sh scripts/clone-repos.sh
shellcheck scripts/check-setup.sh scripts/test-codex-app-installer.sh scripts/test-ssh-config.sh .githooks/pre-commit
